...
TUTORIAL_STEPS = [
    ...
    },
    {
        ...
        "media_src": "/assets/tutorial/upload_sample_pdf.gif",
        ...
        "text": "Upload the downloaded ABF Annual Report 2025 file through the Upload PDF box. Once the supported sample file is selected, the simulated pipeline starts automatically and the job status cards begin to update. This step demonstrates the transition from a raw source document to the document-processing pipeline.",
        "hint": "Only the sample PDF is supported in this prototype. Other PDFs trigger a warning modal and do not start the pipeline, because the prompt-chain outputs and Human Review examples are intentionally preconfigured for this document.",
    },
    {
        "title": "4. Read the pipeline",
    ...
    {
        "title": "6. Inspect prompt-chain steps",
    ...
    {
        "title": "8. Confirm records individually or all at once",
    ...
    {
        "title": "9. Check final RDB output",
